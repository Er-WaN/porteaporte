...
<%@ page import="fr.ps.porteaporte.Role" %>
<!DOCTYPE html>
<html>
	<head>
		<meta name="layout" content="main">
		<g:set var="entityName" value="${message(code: 'role.label', default: 'Role')}" />
		<title><g:message code="role.show.label" args="[entityName]" /></title>
	</head>
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="list" action="index"><g:message code="role.list.label" args="[entityName]" /></g:link></li>
				<li><g:link class="create" action="create"><g:message code="role.new.label" args="[entityName]" /></g:link></li>
			</ul>
		</div>
		<div id="show-role" class="content scaffold-show" role="main">
			<h1><g:message code="role.show.label" args="[entityName]" /></h1>
